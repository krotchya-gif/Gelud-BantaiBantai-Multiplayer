...
Object.assign(soloBrawler, {
  alive: true, heldItems: ['shield', 'heal'], heldItem: 'shield', shieldT: 0, itemSpeedT: 0,
...
console.log('PASS: eight rigs, bot roster, solo items/Flicker/traps, multiplayer visual lifecycle, quality fallback, material ownership, silhouettes, and combat tuning.');
