...
export const CHARACTER_DEFS = Object.freeze({
  ...
  ace: Object.freeze({ id: 'ace', speed: 3.25, maxHp: 3000, superCharge: 3600, attack: { kind: 'projectile', count: 6, damage: 220, speed: 25, range: 8.2, spread: 0.16, cooldown: 1 }, super: { kind: 'burst', count: 12, damage: 220, speed: 21, range: 11.5, radius: 0.2, pierce: true } }),
